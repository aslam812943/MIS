      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
              ...
              <div key={idx} className="flex flex-col gap-2">
                ...
                {field.type === 'text' && (
                  <input
                    ...
                    className="bg-slate-950 border border-slate-800 text-white rounded-xl px-4 py-2.5 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                  />
                )}
                {field.type === 'number' && (
                  <input
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 border-t border-slate-800">
          ...
          <div className="flex gap-3">
            <button
              onClick={handleClear}
              className="px-6 py-2 rounded-xl text-slate-300 hover:text-white border border-slate-700 hover:bg-slate-800 transition-all font-medium"
            >
              Clear
            </button>
            <button
              onClick={handleSave}
              disabled={isSaving || !module.fields || module.fields.length === 0}
