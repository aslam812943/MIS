...
const PrivilegeReportsPage: React.FC = () => {
  ...
  return <DashboardLayout>
    <style>{`@page { size: A4 landscape; margin: 9mm; } @media print { * { print-color-adjust:exact!important; -webkit-print-color-adjust:exact!important; } body { background:#fff!important; color:#172033!important; } aside, header, .report-actions, .report-filters { display:none!important; } main { margin:0!important; padding:0!important; } .report-page { max-width:none!important; padding:0!important; display:block!important; } .report-header { border:0!important; padding:0 0 4mm!important; margin-bottom:4mm!important; } .report-header > div:first-child { display:none!important; } .report-kpis { display:grid!important; grid-template-columns:repeat(4,1fr)!important; gap:3mm!important; margin-bottom:4mm!important; } .report-kpis > div { padding:3mm!important; border:1px solid #cbd5e1!important; break-inside:avoid; } .report-kpis svg { display:none!important; } .report-rankings { display:grid!important; grid-template-columns:repeat(2,1fr)!important; gap:3mm!important; margin-bottom:4mm!important; } .report-rankings > div { break-inside:avoid; border:1px solid #cbd5e1!important; } .report-rankings > div > div:nth-child(2) { max-height:none!important; } .report-detail, .report-branches { break-before:page; border:0!important; } .report-table { overflow:visible!important; max-height:none!important; } .report-table table { min-width:0!important; width:100%!important; table-layout:fixed!important; font-size:5.5pt!important; } .report-table th, .report-table td { padding:1.2mm!important; white-space:normal!important; overflow:visible!important; text-overflow:clip!important; } .report-table th:nth-child(7), .report-table td:nth-child(7), .report-table th:nth-child(9), .report-table td:nth-child(9), .report-table th:nth-child(12), .report-table td:nth-child(12), .report-table th:nth-child(17), .report-table td:nth-child(17), .report-table th:nth-child(18), .report-table td:nth-child(18) { display:none!important; } .report-branches table { min-width:0!important; width:100%!important; font-size:8pt!important; } .report-branches th, .report-branches td { padding:2mm!important; } }`}</style>
