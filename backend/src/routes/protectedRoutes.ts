...
router.post('/ra/clients/bulk-preview', requireAuth, (req, res) => raController.bulkCreateClients(req, res, true));
router.post('/ra/clients', requireAuth, (req, res) => raController.createClient(req, res));
router.delete('/ra/clients', requireAuth, (req, res) => raController.bulkClientAction(req, res));
router.patch('/ra/clients', requireAuth, (req, res) => raController.bulkClientAction(req, res));
...
router.delete('/privilege/accounts', requireAuth, (req, res) => privilegeController.bulkDeleteAccounts(req, res));
router.patch('/privilege/accounts', requireAuth, (req, res) => privilegeController.bulkUpdateAccounts(req, res));
